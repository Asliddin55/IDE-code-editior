        ...
        <div className="relative max-w-5xl mx-auto mb-12 space-y-6">
          ...
          <div className="relative group">
            ...
            <div className="relative flex items-center">
              ...
              <input
                ...
                placeholder="Codlarni nomi tili va egasi bilanham qidirish..."
          ...
          <div className="flex flex-wrap items-center gap-4">
            <div className="flex items-center gap-2 px-4 py-2 bg-[#1e1e2e] rounded-lg ring-1 ring-gray-800">
              ...
              <span className="text-sm text-gray-400">Tillar:</span>
            </div>
            ...
            <div className="ml-auto flex items-center gap-3">
              <span className="text-sm text-gray-500">
                {filteredSnippets.length} hozirda code faol
              </span>
        ...
        {filteredSnippets.length === 0 && (
          ...
          >
            <div className="text-center">
              ...
              <h3 className="text-xl font-medium text-white mb-3">Hech qanday code topilmadi</h3>
